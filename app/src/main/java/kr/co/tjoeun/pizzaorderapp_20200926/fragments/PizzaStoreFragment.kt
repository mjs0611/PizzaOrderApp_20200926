...
import kr.co.tjoeun.pizzaorderapp_20200926.adapters.ViewStoreDetailActivity
...
//        fragment_pizza_store xml을 그려서 -> 프래그먼트의 호면으로 (결과로) 지정
...
//        Store 클래스의 생성자에 맞는 순서대로 데이터 기입
...
//        리스트뷰 아이템이 눌렸을 때 (피자 가게 하나가 눌렸을 때) 이벤트 처리
